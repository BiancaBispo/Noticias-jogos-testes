...
<?php
    ...
    $result_categoria01 = "SELECT * FROM vw_produto WHERE Classificacao_01 LIKE '%$categoria01%'";
                            ...
                            <?php echo '<img class="img-responsive mx-auto d-block" src="/noticias_jogos/src/view/edição_dados_admin/upload/'.$rows_categoria01['cImagem'].'" style="width: 210px; height: 210px;" alt="Imagem">';?>
                                ...
                                <div class="overlay">
                                    <div class="hovereffect-title project-icons">
                                        <a href="../produto/vitrine.php?nCdProduto=<?php echo $rows_categoria01['nCdProduto'];?>" data-toggle="modal" data-target=".project-modal2"><i class="fa fa-eye"></i></a>
