...
<!--FIM validação do formulário-->
    ...
    <div class="container">
        <h2>TABELA EDIÇÃO CLASSIFICAÇÃO <small>Acesso administrador</small></h2>
        <!--Codigo em php para ilustrar todos os dados da tabela-->
        <?php $result = $conn->query("SELECT * FROM vw_classificacao") or die($mysqli->error);?>
        ...
        <!--Codigo que puxa as colunas do banco, colocandos na tabela-->
            ...
            <tr>
                ...
                <td><?php echo $row['cNmClassificacao'];?></td>
